...
label_first_name.grid(row=0, column=0, padx=40, pady=10, sticky="w")
label_last_name.grid(row=1, column=0, padx=40, pady=10, sticky="w")
label_email.grid(row=2, column=0, padx=40, pady=10, sticky="w")
label_contact_number.grid(row=3, column=0, padx=40, pady=5, sticky="w")
label_password.grid(row=4, column=0, padx=40, pady=10, sticky="w")
label_gender.grid(row=5, column=0, padx=40, pady=10, sticky="w")


entry_first_name.grid(row=0, column=1, padx=40, pady=10, sticky="w")
entry_last_name.grid(row=1, column=1, padx=40, pady=10, sticky="w")
entry_email.grid(row=2, column=1, padx=40, pady=10, sticky="w")
entry_contact_number.grid(row=3, column=1, padx=40, pady=10, sticky="w")
entry_password.grid(row=4, column=1, padx=40, pady=10, sticky="w")
gender_combobox.grid(row=5, column=1, padx=40, pady=10, sticky="w")
